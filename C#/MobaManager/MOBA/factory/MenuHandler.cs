...
namespace Game.Factory
{
    class MenuHandler
    {
		...
		*/
		...
		/*
		public bool CheckButtons(Game1 game, MouseState thismouse, MouseState lastmouse, Vector2 mouse)
        {
		...
		public void HandleButton(Game1 game, Button b)
        {
            switch (b.attribute)
            {
                case "play":
		...
		public void ApplyChanges(Game1 game)
        {
            game.graphics.PreferredBackBufferWidth = Convert.ToInt32(settings[1]);
            game.graphics.PreferredBackBufferHeight = Convert.ToInt32(settings[3]);
