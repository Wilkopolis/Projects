...
namespace Rougelike.Types
{
    public class Item : Entity, IEquatable<Item>
    {
        ...
        public enum Effect { STYLISH = 1, SHARP = 2, LIGHT = 3, LONG = 4, ONEHANDED = 101, SWORD = 102, SPLINTER = 5, THORNS = -1, DOUBLING = 6 };
        public enum ItemType { HEAD, CHEST, LEGS, BOOTS, BELT, WEILD, NECK, RINGL, RINGR, CONSUMABLE, INVENTORY };
        public Dictionary<Item.Effect, int> Mods = new Dictionary<Item.Effect, int>();
