...
namespace BoneStorm
{
    ...
    partial class BoneStormEditor
    {
        ...
        void LoadArt()
        {
            SegeoUiMono = Content.Load<SpriteFont>("SegeoUiMono");

            Sprites.Background = Content.Load<Texture2D>("art/editor.png");

            Cursor.SpriteSheet = Content.Load<Texture2D>("art/cursors.png");
            Cursor.Rectangle = new Rectangle(448,384,64,64);

            Sprites.SimulatorCursor = Content.Load<Texture2D>("art/editor_cursor.png");
            ...
            Simulator.boss = new DootDoot(Sprites.DootDoot, Sprites.DootDootSchedule);
        }
