...
namespace BoneStorm
{
    ...
    {
        float SPEED_UP_FAST = -20;
        float SPEED_HOR_SLOW = 5;
        float SPEED_HOR_SLOWER = 4;
        float SPEED_HOR_FAST = 6;

        Vector2 VEC_GRAVITY  = new Vector2(0, 1f);
        Vector2 VEC_TERMINAL = new Vector2(20, 20);
        
        void SpawnWalker(Barrels barrel)
        {
            // create the enemy
        ...
        void SpawnSword1(Barrels barrel)
        {
            // create the enemy
