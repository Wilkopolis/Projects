...
namespace Rougelike.Factory
{
    class MenuHandler
    {
        ...
        public MenuHandler(Template game)
        {
            // Load Settings
            try
            {
        ...
        public bool CheckButtons(Template game, MouseState thismouse, MouseState lastmouse, Vector2 mouse, System.Windows.Forms.Form form)
        {
        ...
        public void HandleButton(Template game, Button b)
        {
            switch (b.attribute)
            {
                case "play":
                    game.gamestate = Template.State.Game;
                    game.SetButtons(gamebuttons);
                    break;

                case "options":
                    game.gamestate = Template.State.Options;
                ...
                case "back":
                    game.gamestate = Template.State.Title;
        ...
        public void ApplyChanges(Template game)
        {
            game.graphics.PreferredBackBufferWidth = Convert.ToInt32(settings[1]);
            game.graphics.PreferredBackBufferHeight = Convert.ToInt32(settings[3]);
