...
function Dungeon () {
	...
	this.buildRoom = function(room, templates) {
		...
		switch (room.size) {
			...
			var blueprint = blueprints.peekRandom();
			tiles = blueprint.tiles;
			room.isRoom = blueprint.isRoom;
			// var pos = room.seedPos;
			// // check adjacent segments, if all non-empty, make us the open room
			// if (pos.y > 0 && minimap[pos.y - 1][pos.x].hash != 0 &&
			// 	pos.x > 0 && minimap[pos.y][pos.x - 1].hash != 0 &&
			// 	pos.y < minimap.length - 1 && minimap[pos.y + 1][pos.x - 1].hash != 0 &&
			// 	pos.y < minimap.length - 1 && minimap[pos.y + 1][pos.x - 1].hash != 0) {
	...
	minimap[seedRoomPos.y][seedRoomPos.x].visited = true;
	...
	factions[FACTION_CLONES].init(this.tiles);
	...
	this.movePlayer = function(pos) {
		...
		if (room.isRoom && !room.visited && newTile.contains(ENTITY_DOOR))
...
function getOpenSpot(destination) {
	...
	do {
		...
		for (var i = 0; i < MOVE_OPTIONS.length; i++) {
			var newPos = {x:pos.x + MOVE_OPTIONS[i].x, y:pos.y + MOVE_OPTIONS[i].y}
...
function EmptyTile () {
	...
	this.getCharAndFont = function() {
		return {char:' ', font:FONT_STYLE_DEFAULT, hasHp:false};
	}
	...
	this.getCharAndFont = function() {
		switch (this.viewState) {
			case VIEW_STATE_HIDDEN:
				return {char:CHAR_HIDDEN, font:FONT_STYLE_DEFAULT, hasHp:false};
			break;

			case VIEW_STATE_VISIBLE:
				this.viewState = VIEW_STATE_SEEN;
				if (this.entities.length > 0)
					return {char: entity.char, font: entity.font, hasHp:false};
				return {char:this.char, font:FONT_STYLE_DEFAULT, hasHp:false};
			break;
...
function FloorTile (inRoom, entity) {
			...
			case VIEW_STATE_VISIBLE:
				if (this.entities.length > 0) {
					...
					if (typeof entity.hp !== 'undefined' && entity.hp != entity.hpMax)
						return {char: entity.char, font: entity.font, hasHp:true, hp:entity.hp/entity.hpMax};
					return {char: entity.char, font: entity.font, hasHp:false};
				}
				else
					return {char: CHAR_FLOOR_TILE, font: FONT_STYLE_DEFAULT, hasHp:false};
			break;
					...
					if (this.entities.length != 0) {
						...
						for (var i = this.entities.length - 1; i >= 0; i--) {
							...
							if (typeof this.entities[i].visible !== 'undefined' && !this.entities[i].visible)
								...
								return {char:this.entities[i].char, font:this.entities[i].font, hasHp:false};
						}
					}
				}
	...
	this.visit = function() {
		if (this.viewState == VIEW_STATE_VISIBLE) {
			this.pastEntityHash = null;	
			if (this.entities.length > 0 && typeof this.entities.peek().visible !== 'undefined' && 
				this.entities.peek().visible && typeof this.entities.peek().hash !== 'undefined') {
...
var Y = "city_console";
// shops
var SYMBOL_SHOP_KEEPER = "shop_keeper";
var A = "shop_keeper";
...
var ROOM_TEMPLATES = {
	...
	SHOP_TEMPLATES : {
		1 :[
			 {
				 tiles:[[d,g,n,n,n,n,n,n,n,n,n,a,b],			
						[m,x,x,x,x,x,i,x,x,x,x,x,c],
						[w,x,o,o,o,o,o,u,o,o,o,x,e],
						[w,x,o,x,x,x,o,u,o,A,o,x,e],
						[w,x,o,o,o,o,o,u,o,o,o,x,e],
						[w,x,o,x,x,x,o,u,u,o,u,x,e],
						[w,l,o,o,o,o,o,o,o,o,o,j,e],
						[w,x,o,o,o,o,o,o,o,o,o,x,e],
						[w,x,u,o,o,x,o,x,o,o,u,x,e],
						[w,x,u,o,o,o,o,o,o,o,u,x,e],
						[w,x,u,u,u,o,o,o,u,u,u,x,e],
						[p,x,x,x,x,x,k,x,x,x,x,x,t],
						[f,q,s,s,s,s,s,s,s,s,s,r,h]],
		...
		4 :[[d,g,n,n,n,n,n,n,n,n,n,a,b,d,g,n,n,n,n,n,n,n,n,n,a,b],	
			...
			[w,x,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,x,e],
			[w,x,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,x,e],
			[w,l,o,o,o,o,A,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,j,e],
			[w,x,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,x,e],
			[w,x,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,x,e],
			[w,x,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,x,e],
			[w,x,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,o,x,e],
