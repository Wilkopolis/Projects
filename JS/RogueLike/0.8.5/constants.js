...
var COLOR_FACTIONS_UNPOWERED = {animal: '#40552b', software: '#407493', robot: '#a9a434', survivor: '#9b4242', hivemind: '#503472', clones:'#9e3a8f', unclaimed:'#cdc0b6'};
...
var CLASSES = [{name:CLASS_DEFAULT, selected:true}];
// , {name:CLASS_MAYOR, selected:false},
// 	{name:CLASS_PHARMACIST, selected:false}, {name:CLASS_INVESTOR, selected:false},
// 	{name:CLASS_SOLDIER, selected:false}, {name:CLASS_STUDENT, selected:false}];
...
var BACKGROUNDS = [{name:GENOME_JOEY, selected:true}];
// [{name:GENOME_ESTER, selected:true}, 
//  	{name:GENOME_TIMMY, selected:false}, {name:GENOME_ANDRE, selected:false}, 
//  	{name:GENOME_WHISKERS, selected:false}, {name:GENOME_VALERIE, selected:false}];
