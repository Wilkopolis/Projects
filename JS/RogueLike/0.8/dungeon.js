...
function Dungeon () {
	...
	factions[FACTION_CLONES] = new faction_clones(seedRoomPos, startingWealth, this.tiles);
			...
			case VIEW_STATE_VISIBLE:
				if (this.entities.length > 0) {
					...
					if (typeof entity.hp !== 'undefined' && entity.hp != entity.hpMax)
						return {char: entity.char, font: FONT_STYLE_DEFAULT, hasHp:true, hp:entity.hp/entity.hpMax};
					return {char: entity.char, font: FONT_STYLE_DEFAULT, hasHp:false};
				}
				else
