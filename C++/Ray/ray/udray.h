...
typedef struct intersectionstruct 
{
	...
	Sphere *sphere;  		// sphere we may be entering
	GLMmodel *model; 		// model we may be entering

	// need this for depth mapping
	
	Vect objP;				// the position of the hit object; 
...
// Me
void shade_ray_recursive(int, Ray *, Intersection *, Vect, double);
void shade_ray_depth(Ray *, Intersection *, Vect);
void shade_obj_depth(Ray *, Intersection *, Vect);
void shade_ray_local_distance(Ray *, Intersection *, Vect , double);
Intersection *intersect_ray_glm_object_to_light(Ray *, GLMmodel *, double);
Intersection *intersect_ray_sphere_to_light(Ray *, Sphere *, double);
void render();
// End Me
